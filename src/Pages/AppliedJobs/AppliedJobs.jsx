...
const AppliedJobs = () => {
  ...
  const handleOn = ()=>{
        const onTime = nyJob.filter(job=> job.jobCategory == 'On Site')
        setAppliedjobs(onTime)
  }
  const handlePart = ()=>{
        const part = nyJob.filter(job=> job.jobCategory == 'Part Time')
        setAppliedjobs(part)
  }
  const handleHybrid = ()=>{
        const hybrid = nyJob.filter(job=> job.jobCategory == 'Hybrid')
        setAppliedjobs(hybrid)
  }
  return (
    <div>
      <Navbar></Navbar>
  ...
  {job.jobCategory}
                  ...
                  <td>
                    <button
                      className=" btn btn-outline text-lg text-blue-300"
                    >
                      Details
                    </button>
                  </td>
